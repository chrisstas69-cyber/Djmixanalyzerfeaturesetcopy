...
export function LoginPage({ onLogin, onSwitchToSignUp, onGoogleLogin, onForgotPassword }: LoginPageProps) {
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#1a1a1a] rounded-xl border border-gray-800 p-8">
          ...
          <p className="text-gray-400 mb-6">Login to continue creating</p>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <button
                  ...
                  className="text-sm text-[#ff6b35] hover:text-[#ff7f4d] transition-colors"
                >
                  Forgot password?
                </button>
              </div>
